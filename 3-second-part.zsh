...
# Sentences 9 and 27
printstrings -n 1 -u --input=output/example/LATS.C.towards_ref/9.fst.gz --output=9.C.dvn1
draw_tree.sh 9.C.dvn1 $DIR/rules/test30/C/r.9.gz output/tree.9.C.dvn1.jpg
